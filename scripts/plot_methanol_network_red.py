...
def plot_h2_map(n, regions):
    ...
    carriers =  ["methanolisation", "Methanol steam reforming", "Methanol steam reforming CC"]
    ...
    bus_sizes.rename(index=lambda x: x.replace(" methanol", ""), level=0, inplace=True)
    bus_sizes.rename(index=lambda x: x.replace(" H2", ""), level=0, inplace=True)
    # drop all links which are not H2 pipelines
    n.links.drop(
        n.links.index[~n.links.carrier.str.contains("shipping-meoh")], inplace=True
    )

    h2_new = n.links[n.links.carrier == "shipping-meoh"]
    ...
    n.links.bus0 = n.links.bus0.str.replace(" methanol", "")
    n.links.bus1 = n.links.bus1.str.replace(" methanol", "")
    ...
    bus_colors = {"methanolisation": "#ff29d9", "Methanol steam reforming": "#805394","Methanol steam reforming CC": "#805394"}
   #print(link_widths_total)
   #print(n.links)
   ...
   #)
    ...
    labels = carriers + ["Methanol shipping"]
