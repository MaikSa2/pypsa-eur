...
def plot_h2_map(n, regions):
    ...
    carriers =  ["Haber-Bosch", "ammonia cracker"]            #H2 Electrolysis", "H2 Fuel Cell
    ...
    bus_sizes.rename(index=lambda x: x.replace(" NH3", ""), level=0, inplace=True)
    # drop all links which are not H2 pipelines
    n.links.drop(
        n.links.index[~n.links.carrier.str.contains("shipping-nh3")], inplace=True
    )

    h2_new = n.links[n.links.carrier == "shipping-nh3"]
    ...
    n.links.bus0 = n.links.bus0.str.replace(" NH3", "")
    n.links.bus1 = n.links.bus1.str.replace(" NH3", "")
